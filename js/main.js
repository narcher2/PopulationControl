...
function preload() {
    ...
    game.load.image('cat', 'assets/cat2.png');
    game.load.image('cat', 'assets/cat3.png');
    game.load.image('cat', 'assets/cat4.png');
...
function ballHitPaddle (_ball, _paddle) {
    ...
    if (_ball.x < _paddle.x+32)
    {
        //  Ball is on the left-hand side of the paddle
        diff = _paddle.x+32 - _ball.x;
        _ball.body.velocity.x = (-10 * diff);
    }
    else if (_ball.x > _paddle.x+32)
    {
        //  Ball is on the right-hand side of the paddle
        diff = _ball.x -_paddle.x+32;
        _ball.body.velocity.x = (10 * diff);
    }
    else
    {
